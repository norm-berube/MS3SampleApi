...
namespace API_Sample2
{
    public class DAL
    {
        ...
        public static List<Identification> GetClients()
        {
            ...
            using (SqlDataAdapter sda = new SqlDataAdapter(idCmd))
            {
                using (DataTable dt = new DataTable())
                {
                    ...
                    {
                        ids.Add(Identification.ByDataRow(row));
                    }
                }
            }
        ...
        public static Identification GetClient(int pkId)
        {
            ...
            using (SqlDataAdapter sda = new SqlDataAdapter(idCmd))
            {
                ...
                {
                    sda.Fill(dt);
                    ident = Identification.ByDataRow(dt.Rows[0]);
                }
            }
            ...
            using (SqlDataAdapter sda = new SqlDataAdapter(idCmd))
            {
                using (DataTable dt = new DataTable())
                {
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ident.Address.Add(Address.ByDataRow(row));
                    }
                }
            }
            ...
            using (SqlDataAdapter sda = new SqlDataAdapter(idCmd))
            {
                using (DataTable dt = new DataTable())
                {
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ident.Communication.Add(Contact.ByDataRow(row));
                    }
                }
            }
        ...
        public static Identification SaveFullId(Identification model)
        {
            ...
            Identification results = new Identification();
            ...
            try
            {
                ...
                if (pkId == 0)          //Do an insert
                {
                    ...
                    foreach (Address addr in model.Address)
                    {
                        SaveAddress(addr, pkId, conn);
                    }

                    foreach (Contact com in model.Communication)
                    {
        ...
        public static void DeleteFullId(int id)
        {
            ...
            try
            {
                ...
                Identification model = GetClient(id);
                ...
                foreach (Contact comm in model.Communication)
                {
        ...
        #region "Client"
        private static int SaveClient(Identification model, SqlConnection conn)
        {
        ...
        private static void UpdateClient(Identification model, SqlConnection conn)
        {
